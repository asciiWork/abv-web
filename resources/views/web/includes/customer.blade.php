                    ...
                    <div class="swiper-slide">
                        <article class="product__card">
                            ...
                            <div class="product__card--content">
                                ...
                                <h3 class="product__card--title">{{substr($gog->review,0,100)}}<span class="more-content hidden"> {{substr($gog->review,100)}}</span></h3>
                                @if(strlen($gog->review)>100)
                ...
                <div class="swiper-slide">
                    <article class="product__card">
                        ...
                        <div class="product__card--content">
                            ...
                            <h3 class="product__card--title">ABV trade and solutions provide excellent quality <span class="more-content hidden"> tools in a very quick time. They provide complete solutions for your queries and also suggest proper solutions for your problems.They have excellent customer service for dealing with clients.</span></h3>
                            <a href="javascript:void(0);" class="read-more-btn">Read More</a>
                        </div>
                    </article>
                </div>
                <div class="swiper-slide">
                    <article class="product__card">
                        ...
                        <div class="product__card--content">
                            ...
                            <h3 class="product__card--title">Best tool supply in router industry , Good tool quality with best economical rate. <br></h3>
                        </div>
                    </article>
                </div>
                <div class="swiper-slide">
                    <article class="product__card">
                        ...
                        <div class="product__card--content">
                            ...
                            <h4 class="product__card--title">Really long lasting tool for various operations, <span class="more-content hidden"> and one good technical adviser for machining process.Highly Recommended for tooling selection</span></h4>
                            <a href="javascript:void(0);" class="read-more-btn">Read More</a>
                        </div>
                    </article>
                </div>
                <div class="swiper-slide">
                    <article class="product__card">
                        ...
                        <div class="product__card--content">
                            ...
                            <h4 class="product__card--title">All products are made with good quality material and durable,<span class="more-content hidden"> with reasonable price of tools. Very nice service with good, cooperative behaviour. </span></h4>
                            <a href="javascript:void(0);" class="read-more-btn">Read More</a>
                        </div>
                    </article>
                </div>
