        ...
        <div class="container-fluid">
            <div class="main__header--inner position__relative d-flex justify-content-between align-items-center">
                ...
                <div class="main__logo">
                    <h1 class="main__logo--title"><a class="main__logo--link" href="index.html"><img class="main__logo--img" src="{{ asset('webtheme/assets/img/logo/nav-log.webp') }}" alt="logo-img"></a></h1>
                </div>
                        ...
                        <ul class="header__menu--wrapper d-flex">
                            <li class="header__menu--items">
                                ...
                                <ul class="header__sub--menu">
                                    <li class="header__sub--menu__items"><a href="{{route('web.index')}}" class="header__sub--menu__link">Home</a></li>
                                </ul>
                            </li>
                            <li class="header__menu--items mega__menu--items">
                                ...
                                <ul class="header__mega--menu d-flex">
                                    ...
                                    <li class="header__mega--menu__li fullscreen__style d-flex">
                                        <a class="header__mega--menu__banner display-block" href="shop.html"><img class="header__mega--menu__banner--img" src="{{ asset('webtheme/assets/img/banner/banner7.webp') }}" alt="banner-menu">
                                        ...
                                        <a class="header__mega--menu__banner display-block" href="shop.html"><img class="header__mega--menu__banner--img" src="{{ asset('webtheme/assets/img/banner/banner8.webp') }}" alt="banner-menu">
                                        ...
                                        <a class="header__mega--menu__banner display-block" href="shop.html"><img class="header__mega--menu__banner--img" src="{{ asset('webtheme/assets/img/banner/banner10.webp') }}" alt="banner-menu">
                                            <div class="banner__content">
        ...
        <div class="offcanvas__inner">
            <div class="offcanvas__logo">
                <a class="offcanvas__logo_link" href="index.html">
                    <img src="{{ asset('webtheme/assets/img/logo/nav-log.webp') }}" alt="Grocee Logo" width="158" height="36">
                </a>
                ...
                <div class="offcanvas__account--wrapper d-flex">
                    <div class="offcanvas__account--currency">
                        <a class="offcanvas__account--currency__menu d-flex align-items-center text-black" href="javascript:void(0)">
                            <img src="{{ asset('webtheme/assets/img/icon/usd-icon.webp') }}" alt="currency">
                            <span>USD</span>
        ...
        <div class="minicart__product">
            <div class="minicart__product--items d-flex">
                <div class="minicart__thumb">
                    <a href="product-details.html"><img src="{{ asset('webtheme/assets/img/product/small-product/product1.webp') }}" alt="prduct-img"></a>
                </div>
            ...
            <div class="minicart__product--items d-flex">
                <div class="minicart__thumb">
                    <a href="product-details.html"><img src="{{ asset('webtheme/assets/img/product/small-product/product2.webp') }}" alt="prduct-img"></a>
                </div>
                <div class="minicart__text">
