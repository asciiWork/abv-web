...
@include('web.includes.bannerSection')
<!-- End banner section -->
                    ...
                    <article class="product__card">
                        <div class="product__card--thumbnail">
                            ...
                            <ul class="product__card--action d-flex align-items-center justify-content-center">
                                <li class="product__card--action__list">
                                    <a class="product__card--action__btn" title="Quick View" onclick="openQuickModal('{{$pro->id}}');" href="javascript:void(0)">
                        ...
                        <div class="product__card--content">
                            <ul class="rating product__card--rating d-flex">
                                ...
                                @endfor
                                <li>
                                    <span class="rating__review--text">({{$pro->total_reviews}}) Review</span>
                                </li>
                            </ul>
                            ...
                            <div class="product__card--price">
                                ...
                                <span class="current__price">₹{{ $pro->product_min_price }}</span> - <span class="current__price">₹{{ $pro->product_max_price }}</span>
                            </div>
                    ...
                    <div class="single__product--wrapper">
                        <div class="single__product--topbar d-flex align-items-center">
                            ...
                            <div class="single__product--content">
                                ...
                                <h3 class="single__product--title h2"><a href="{{ URL::to('product-details/') }}/{{$dealProduct[0]->product_slug}}">{{ $dealProduct[0]->product_name }} </a></h3>
                                <div class="product__card--price">
