            ...
            <div class="col">
                <div class="product__details--info">
                    <form action="#">
                        ...
                        <p class="product__details--info__desc mb-15">{{substr($proData->product_detail,0,150)}} ...</p>
                        ...
                        <div id="description" class="tab_pane active show">
                            <div class="product__tab--content">
                                <div class="product__tab--content__step mb-30">
                                    <h2 class="product__tab--content__title h4 mb-10">{{$proData->product_name}}</h2>
                                    <p class="product__tab--content__desc">{{$proData->product_detail}}</p>
                                </div>
