                                    ...
                                    <tr class="cart__table--body__items">
                                        <td class="cart__table--body__list">
                                            <div class="cart__product d-flex align-items-center">
                                                <button class="cart__remove--btn remove-cart-btn" aria-label="search button" type="button" data-id="{{ $c['id'] }}" data-size="{{ $c['prosize'] }}" action="{{ route('remove-cart') }}" isRefresh="1">
                                        ...
                                        <td class="cart__table--body__list">
                                            <div class="quantity__box">
                                                <a type="minus" data-id="{{ $c['id'] }}" data-size="{{ $c['prosize'] }}" class="increase-decrease-cart-btn quantity__value quickview__value--quantity decrease" aria-label="quantity value" action="{{route('inc-dec-cart')}}" value="Decrease Value">-</a>
                                                <label>
                                                    <input type="number" name="qnt" class="quantity__number quickview__value--number" value="{{$c['qnt']}}" data-counter />
                                                </label>
                                                <a type="plus" data-id="{{ $c['id'] }}" data-size="{{ $c['prosize'] }}"class="increase-decrease-cart-btn quantity__value quickview__value--quantity increase" aria-label="quantity value" action="{{route('inc-dec-cart')}}" value="Increase Value">+</a>
                                            </div>
                                        </td>
                                        <td class="cart__table--body__list">
