...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('webtheme/assets/img/favicon.ico')}} ">

    <!-- ======= All CSS Plugins here ======== -->
    <link rel="stylesheet" href="{{ asset('webtheme/assets/css/plugins/swiper-bundle.min.css')}} ">
    <link rel="stylesheet" href="{{ asset('webtheme/assets/css/plugins/glightbox.min.css')}} ">
    <link href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700;800;900&family=Open+Sans:ital,wght@0,300;0,400;0,500;0,600;0,700;0,800;1,300;1,400;1,500;1,600;1,700&family=Rubik:ital,wght@0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,300;1,400;1,500&display=swap" rel="stylesheet">

    <!-- Plugin css -->
    <link rel="stylesheet" href="{{ asset('webtheme/assets/css/vendor/bootstrap.min.css') }}">
...
<body>
    ...
    <script src="{{ asset('webtheme/assets/js/vendor/popper.js') }}" defer="defer"></script>
    <script src="{{ asset('webtheme/assets/js/vendor/bootstrap.min.js') }}" defer="defer"></script>
    <script src="{{ asset('webtheme/assets/js/plugins/swiper-bundle.min.js') }}"></script>
    <script src="{{ asset('webtheme/assets/js/plugins/glightbox.min.js') }}"></script>
