        ...
        <div class="team__container">
            <div class="row mb--n30">
                <div class="col-lg-3 col-md-4 col-sm-6 col-6 custom-col mb-30">
                    <div class="team__items text-center">
                        <div class="team__thumb">
                            <img class="team__thumb--img" src="{{ asset('web/assets/img/other/team1.webp') }}" alt="team img">
                        </div>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 col-6 custom-col mb-30">
                    <div class="team__items text-center">
                        <div class="team__thumb">
                            <img class="team__thumb--img" src="{{ asset('web/assets/img/other/team2.webp') }}" alt="team img">
                        </div>
                        <div class="team__content">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 col-6 custom-col mb-30">
                    <div class="team__items text-center">
                        <div class="team__thumb">
                            <img class="team__thumb--img" src="{{ asset('web/assets/img/other/team3.webp') }}" alt="team img">
                        </div>
                        <div class="team__content">
