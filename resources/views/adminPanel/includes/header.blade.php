    ...
    <div class="shadow-sm">
        <div class="relative flex w-full items-center bg-white px-5 py-2.5 dark:bg-[#0e1726]">
            <div class="horizontal-logo flex items-center justify-between ltr:mr-2 rtl:ml-2 lg:hidden">
                <a href="javascript:void(0);" class="main-logo flex shrink-0 items-center">
                    <img class="inline w-8 ltr:-ml-1 rtl:-mr-1" src="{{ asset('web/assets/img/abv.png')}}" alt="image" />
        ...
        >
            <li class="menu nav-item relative">
                <a href="{{route('admin-dashboard')}}" class="nav-link {{ ($crrRoute == 'admin-dashboard')?'active':'' }}">
            ...
            <li class="menu nav-item relative">
                <a href="{{ route('admin-users.index') }}" class="nav-link {{ ($crrRoute == 'admin-users.index')?'active':'' }}">
                    <div class="flex items-center">
                        <svg class="shrink-0 group-hover:!text-primary" width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <circle opacity="0.5" cx="15" cy="6" r="3" fill="currentColor" />
                                <ellipse opacity="0.5" cx="16" cy="17" rx="5" ry="3" fill="currentColor" />
            ...
            <li class="menu nav-item relative">
                <a href="{{ route('admin-orders.index') }}" class="nav-link {{ ($crrRoute == 'admin-orders.index')?'active':'' }}">
                    <div class="flex items-center">
                        <svg
                        ...
                        <span class="px-1">Orders</span>
                    </div>
                </a>
            </li>
            <li class="menu nav-item relative">
                <a href="{{ route('admin-category.index') }}" class="nav-link {{ ($crrRoute == 'admin-category.index')?'active':'' }}">
                    <div class="flex items-center">
                        <svg class="shrink-0 group-hover:!text-primary" width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <li class="menu nav-item relative">
                <a href="{{ route('admin-products.index') }}" class="nav-link {{ ($crrRoute == 'admin-products.index')?'active':'' }}">
                    <div class="flex items-center">
                        <svg class="shrink-0 group-hover:!text-primary" width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <li class="menu nav-item relative">
                <a href="{{ route('admin-contacts') }}" class="nav-link {{ ($crrRoute == 'admin-contacts')?'active':'' }}">
                    <div class="flex items-center">
                        <svg
                                class="shrink-0 group-hover:!text-primary"
                                width="20"
